...
export default function UploadTickerReports() {
  ...
  const fetchTickerReports = async () => {
    ...
    try {
      const fetchAllTickerReportsRes = await fetchWithInterceptor(
  ...
  const downloadReport = async (fileName) => {
    context.setLoaderState(true);
    try {
      const downloadApiRes = await fetchWithInterceptor(
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          const rowDeleteRes = await fetchWithInterceptor(
            "/api/proxy?api=deleteTickerReport?idTickerReports=" + id,
            false,
            false,
            {
              method: "DELETE",
