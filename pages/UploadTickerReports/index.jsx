...
export default function UploadTickerReports() {
  ...
  const fetchTickersFunc = async () => {
    try {
      const fetchTickers = await fetchWithInterceptor(
        "/api/proxy?api=getAllTickerByAdmin?_=1716533190772",
        false
      );
  ...
  const fetchTickerReports = async () => {
    ...
    try {
      const fetchAllTickerReports = await fetchWithInterceptor(
        "/api/proxy?api=getAllTickerReports?_=1716974778979",
        false
      );
      const fetchAllTickerReportsRes = fetchAllTickerReports;
  ...
  const downloadReport = async (fileName) => {
    context.setLoaderState(true);
    try {
      const downloadApi = await fetchWithInterceptor(
        "/api/proxy?api=downloadTickerReport?fileName=" + fileName,
        false
      );
      const downloadApiRes = downloadApi;
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          const rowDelete = await fetchWithInterceptor(
            "/api/proxy?api=deleteTickerReport",
            false,
            {},
            {
              method: "DELETE",
        ...
        <div className="content-wrapper">
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option value="Grab and Go 7-packs">
                        Grab and Go 7-packs
                      </option>
          ...
          <div className="table-responsive">
            <table className="table">
              <thead>
                <tr>
                  <th onClick={() => handleSort("tickerName")}>
                  ...
                  <th onClick={() => handleSort("catagoryType")}>
                    Report Type {getSortIcon("catagoryType", sortConfig)}
                  </th>
                      ...
                      <tr key={"report" + index}>
                        ...
                        <td className="sticky-action">
                          ...
                          <button
                            ...
                            title="delete"
                            onClick={() => {
                              deleteTickerReport(item?.idTickerReports);
                            }}
                          >
