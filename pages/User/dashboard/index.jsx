    ...
    return (
        ...
        <Breadcrumb />
                    ...
                    <div className="row justify-content-center animate__animated animate__fadeInLeft">
                        ...
                        <div className="col-md-6 col-lg-4 stretch-card grid-margin">
                        <Card route="/portfolios" bg="bg-orange" img="/icons/Portfolio.png" title="Model Portfolios" />
                        </div>
                        <div className="col-md-6 col-lg-4 stretch-card grid-margin">
                        <Card route="/insights" bg="bg-red" img="/icons/Insights.png" title="Model Insights" />
                        </div>
                        <div className="col-md-6 col-lg-4 stretch-card grid-margin">
