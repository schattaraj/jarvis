...
export default function PemDetails() {
    ...
    const fetchData = async () => {
        ...
        try {
            const getBonds = await fetch("https://jharvis.com/JarvisV2/getImportsData?metaDataName=PEM_NEW&_=1725280825673")
    ...
    return (
        <>
            <div className="main-panel">
                ...
                <Modal show={show} onHide={handleClose} className="pem-new-calculate-modal">
