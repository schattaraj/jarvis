  ...
  const fetchAllAnalystVideos = async () => {
    ...
    try {
      const getAllAnalystRes = await fetchWithInterceptor(
        "/api/proxy?api=getAllAnalystVideo?_=1716538528362"
      );
    ...
    <>
      <div className="main-panel">
        <div className="content-wrapper">
                    ...
                    <tr key={"analyst" + index}>
                      ...
                      <td className="text-center">
                        <button
                          ...
                          onClick={() => {
                            handleShow(item?.anaylstVideoDetails);
                          }}
                          title="show"
                        >
                        ...
                        <button
                          ...
                          onClick={() => {
                            deleteAnalystVideo(item?.idAnaylstVideo);
                          }}
                          title="delete"
                        >
          ...
          {allAnalystData.length > 0 && (
            <Pagination
              currentPage={currentPage}
              totalItems={allAnalystData}
              limit={limit}
