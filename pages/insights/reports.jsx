...
export default function Reports() {
  ...
  const handleCategoryChange = (selectedOptions) => {
    setCategoryType(selectedOptions ? selectedOptions.map(option => option.value) : []);
  };
  useEffect(() => {
    fetchVideoes()
  }, [])
            ...
            <div className='d-flex justify-content-between align-items-center'>
              <div className="d-flex dt-buttons mb-3">
                <div className="d-flex align-items-center me-2">
                  ...
                  <select name="orderType" className='form-select' onChange={handleChange} style={{ width: "140px", marginRight: "8px" }}>
                ...
                <div className="d-flex align-items-center me-2">
                  ...
                  <select name="sortOrder" className='form-select' onChange={handleChange} style={{ width: "130px", marginRight: "8px" }}>
                ...
                <div className="d-flex align-items-center me-2">
                  ...
                  <Select name="catagoryType" className='w-100 mb-0 me-2 col-md-4' isMulti options={[
                ...
                <div className="d-flex align-items-center me-2"><label htmlFor="" style={{ textWrap: "nowrap" }} className='text-success me-2'>Search : </label><input type="search" name='filterText' placeholder='' className='form-control'  onChange={handleChange} /></div>
                <button className="dt-button buttons-html5 btn-primary h-auto"><span>Filter</span></button>
              </div>
