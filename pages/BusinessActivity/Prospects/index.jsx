...
export default function Prospects() {
  ...
  const fetchData = async () => {
    ...
    try {
      const getBondsRes = await fetchWithInterceptor(
        "/api/proxy?api=getAllProspect?_=1711707171694"
      );
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          const rowDeleteRes = await fetchWithInterceptor(
            "/api/proxy?api=deleteProspect?idProspect=" + id,
            false,
            false,
            {
              method: "DELETE",
  ...
  const getSearchProspects = async (e) => {
    ...
    try {
      ...
      const result = await fetchWithInterceptor(
        "/api/proxy?api=getSearchProspects?mostRecentActivity=" +
          jsonObject.mostRecentActivity +
          "&referredBy=" +
          jsonObject.referredBy +
          "&name=" +
          jsonObject.name +
          "&startDate=" +
        ...
        <div className="content-wrapper">
          ...
          <div className="d-flex justify-content-between">
            <div className="dt-buttons mb-3">
              ...
              <button
                className="dt-button buttons-html5 btn-primary"
                type="button"
                onClick={() => {
                  setCreateModal(true);
                }}
                    ...
                    {columnNames.map((columnName, colIndex) => {
                      ...
                      return (
                        <td
                          key={colIndex}
                          className={
                            columnName?.data == "name" ? "sticky-left" : ""
                          }
                        >
                          {content}
                        </td>
              ...
              <div className="col-md-6">
                <Form.Group className="mb-3" controlId="editmostRecentActivity">
                  ...
                  <Form.Select
                    ...
                    onChange={handleFormData}
                    value={formData?.mostRecentActivity}
                  >
              ...
              <div className="col-md-6">
                <Form.Group className="mb-3" controlId="RM">
                  ...
                  <input
                    type="hidden"
                    name="mostRecentActivity"
                    value={RMdata && RMdata.map((item) => item.value).join(",")}
                  />
                </Form.Group>
              </div>
              <div className="col-md-6">
