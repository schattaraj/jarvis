...
export default function SeminarTracking() {
  const [columnNames, setColumnNames] = useState([
    ...
    {
      data: "appointmentsSetPostSeminar",
      display_name: "Appointments Set Post Seminar",
    },
  ...
  const fetchData = async () => {
    ...
    try {
      const getBondsRes = await fetchWithInterceptor(
        "/api/proxy?api=getAllSeminarTracking"
      );
  ...
  const handleEditModal = async (id) => {
    const getSemeniarRes = await fetchWithInterceptor(
      `/api/proxy?api=getSeminarTrackingByID?idSeminarTracking=${id}`
    );
    ...
    <>
          ...
          <div className="d-md-flex justify-content-between mt-3">
            <div className="dt-buttons">
              ...
              <button
                ...
                onClick={handleOpen}
              >
                <span>Add Seminar Tracking</span>
              </button>
            </div>
                ...
                <tr>
                  ...
                  {columnNames.map((columnName, index) => (
                    <th
                      ...
                      style={{
                        minWidth: columnName.data == "#" ? "4rem" : "auto",
                      }}
                    >
                        ...
                        return (
                          <td key={colIndex} className="sticky-action">
                            <button
                              ...
                              title="Edit"
                              onClick={() => {
                                handleEditModal(rowData?.idSeminarTracking);
                              }}
                            >
                            ...
                            <button
                              ...
                              title="Delete"
                              onClick={() => {
                                deleteSeminarTracking(
                                  rowData?.idSeminarTracking
                                );
                              }}
                            >
                          ...
                          <td className="text-center">
                            <div class="form-check d-flex justify-content-center">
                              <input
                                ...
                                id="checkDefault"
                                checked={selectedSeminar.includes(
                                  rowData?.idSeminarTracking
                                )}
                                onChange={(e) => {
                                  if (e.target.checked) {
                                    ...
                                    setSelectedSeminar(
                                      selectedSeminar.filter(
                                        (id) =>
                                          id !== rowData?.idSeminarTracking
                                      )
                                    );
                                  }
                                }}
                              ...
                              {calculateSum(
                                selectedSeminar.length > 0
                                  ? filterData.filter((row) =>
                                      selectedSeminar.includes(
                                        row.idSeminarTracking
                                      )
                                    )
                                  : filterData,
                                "totalCost"
      ...
      <Modal show={openModal} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>
            {!editData ? "Add" : "Edit"} Seminar Tracking
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form onSubmit={submitForm}>
            {editData ? (
              <Form.Control
                type="hidden"
                name="idSeminarTracking"
                value={editData.idSeminarTracking}
              />
            ) : (
              ""
            )}
              ...
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    ...
                    step="0.01"
                    name="totalCost"
                    defaultValue={editData.totalCost}
                    required
                  />
                </Form.Group>
              </div>
              ...
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Select
                    name="seminarType"
                    required
                    defaultValue={editData.seminarType}
                  >
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    ...
                    defaultValue={editData.geographicLocation}
                    required
                  />
                </Form.Group>
              </div>
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    type="number"
                    name="registeredForSeminar"
                    defaultValue={editData.registeredForSeminar}
                    required
                  />
                </Form.Group>
              </div>
              ...
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    type="number"
                    name="cameToSeminar"
                    defaultValue={editData.cameToSeminar}
                    required
                  />
                </Form.Group>
              </div>
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    ...
                    defaultValue={editData.appointmentsSet}
                    required
                  />
                </Form.Group>
              </div>
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    type="number"
                    name="appointmentsSetPostSeminar"
                    defaultValue={editData.appointmentsSetPostSeminar}
                    required
                  />
                </Form.Group>
              </div>
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    type="text"
                    name="firstMeeting"
                    defaultValue={editData.firstMeeting}
                    required
                  />
                </Form.Group>
              </div>
              ...
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    type="text"
                    name="secondMeeting"
                    defaultValue={editData.secondMeeting}
                    required
                  />
                </Form.Group>
              </div>
              <div className="col-md-6">
                ...
                >
                  ...
                  <Form.Control
                    type="number"
                    name="newClient"
                    defaultValue={editData.newClient}
                    required
                  />
                </Form.Group>
              </div>
